				...
				<div class="am-tabs" id="doc-my-tabs">
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-active">
							...
							<div class="am-cf">
								<input type="submit" name="zc" id="yxzc" onclick="emailzc()" value="注册" disabled="disabled" 
						...
						<div class="am-tab-panel">
							<form method="post" id="form1" action="phonezc">
								...
								<div class="verification">
									<label for="code"><i class="am-icon-code-fork"></i></label> <input
										...
										id="dyMobileButton" onclick="huoqu()">获取</span></a>
								</div>
								<span id="codets" style="margin-left: 10px;"></span>
								<div class="user-pass">
									<label for="password"><i class="am-icon-lock"></i></label> <input
										type="password" name="password" id="ppassword" placeholder="设置密码">
								</div>
								<span id="ppasswordts" style="margin-left: 10px;"></span>
								<div class="user-pass">
									<label for="passwordRepeat"><i class="am-icon-lock"></i></label>
									<input type="password" name="passwordRepeat" id="ppasswordRepeat"
										placeholder="确认密码">
								</div>
								<span id="ppasswordRepeatts" style="margin-left: 10px;"></span>
							</form>
							<div class="login-links">
							...
							<div class="am-cf">
								<input type="submit" name="zc" id="phonezc" onclick="phonezc()"  value="注册" disabled="disabled"
									class="am-btn am-btn-primary am-btn-sm am-fl">
							</div>
